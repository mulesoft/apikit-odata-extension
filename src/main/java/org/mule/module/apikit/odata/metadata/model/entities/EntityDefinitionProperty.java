...
public class EntityDefinitionProperty implements Comparable<EntityDefinitionProperty> {
  ...
  public EntityDefinitionProperty(String name, String type, boolean nullable, boolean key,
      String defaultValue, String maxLength, Boolean fixedLength, String collation, Boolean unicode,
