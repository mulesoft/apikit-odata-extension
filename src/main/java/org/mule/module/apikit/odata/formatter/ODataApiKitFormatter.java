...
public class ODataApiKitFormatter extends ODataPayloadFormatter {
  ...
  public ODataApiKitFormatter(OdataMetadataManager odataMetadataManager, String entityName,
      String url, List<Entry> entities, Integer totalEntitiesCount) {
  ...
  public String format(Format format) throws Exception {
    ...
    FormatWriter<EntitiesResponse> fw = FormatWriterFactory.getFormatWriter(EntitiesResponse.class,
    ...
    EntitiesResponse entitiesResponse =
        Helper.convertEntriesToOEntries(entries, entityName, entitySet, totalEntitiesCount);
