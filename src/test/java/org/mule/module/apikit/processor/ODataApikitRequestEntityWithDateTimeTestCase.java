...
public class ODataApikitRequestEntityWithDateTimeTestCase extends MuleArtifactFunctionalTestCase
{
    ...
    public void getOrderByIdJsonOutput() throws Exception
    {
    	given().header("Accept", "application/json")
            .expect()
                .response().body("d.results.OrderID", hasItem(10248))
                .header("Content-type", "application/json").statusCode(200)
            .when().get("api/odata.svc/orders(10248)?$format=json");
    }
    ...
    public void getOrderByIdNegative() throws Exception
    {
    	given().header("Accept", "application/json")
            .expect()
                .statusCode(500)
            .when().get("api/odata.svc/orders(10250)?$format=json");
    }
    ...
    public void getOrderByIdAtomOutput() throws Exception
    {
    	given()
            .expect()
            	.response().body("feed.entry.content.properties.OrderID", containsString("10248"))
            	.header("Content-type", "application/atom+xml").statusCode(200)
            .when().get("api/odata.svc/orders(10248)?$format=atom");
    }
    ...
    public void getOrderByIdAtomOutputNegative() throws Exception
    {
    	given().header("Accept", "application/xml")
            .expect()
            	.header("Content-type", "application/xml").statusCode(500)
            .when().get("api/odata.svc/orders(20248)?$format=atom");
    }
    ...
    public void settingAtomFormatUsingHeader() throws Exception
    {
    	given().header("Accept", "application/xml")
        .expect()
        	.response().body("eed.entry.content.properties.OrderID", containsString("10248"))
        	.header("Content-type", "application/atom+xml").statusCode(200)
        .when().get("api/odata.svc/orders(10248)");
    }
    ...
    public void creatingEntityUsingXMLBody() throws Exception
    {
        ...
        .expect()
        	.statusCode(200)
        .when().post("api/odata.svc/orders");
    }
    ...
    {
    	given().header("Accept", "application/json")
    	.body("{\"OrderID\":20000,\"ShipAddress\": null,\"ShipName\":\"ship-1\"}")
        .expect()
        	.statusCode(200)
        .when().post("api/odata.svc/orders");
    }
    ...
    {
    	given().header("Accept", "application/json")
    	.body("{\"OrderID\":20000,\"ShipName\":\"ship-1\"}")
        .expect()
        	.statusCode(200)
        .when().post("api/odata.svc/orders");
    }
    ...
    public void gettingOrderWithLessPropertiesShouldNotReturnError() throws Exception
    {
    	given().header("Accept", "application/json")
            .expect()
                .header("Content-type", "application/json").statusCode(200)
            .when().get("api/odata.svc/orders(10249)");
    }
    ...
    public void gettingOrderWithUnknownPropertyShouldReturnError() throws Exception
    {
    	given().header("Accept", "application/json")
            .expect()
                .header("Content-type", "application/json").statusCode(500)
            .when().get("api/odata.svc/orders(10250)");
    }
    ...
    public void filterByOrderDateTestCase() throws Exception
    {
        given().header("Accept", "application/json")
                ...
                .header("Content-type", "application/json").statusCode(200)
                .log().ifError()
                .when().get("api/odata.svc/orders?$filter=OrderDate eq datetime'2017-03-01T00:00:00'");
    }
    ...
    public void filterByOrderDateAndShipNameTestCase() throws Exception
    {
        given().header("Accept", "application/json")
                ...
                .header("Content-type", "application/json").statusCode(200)
                .log().ifError()
                .when().get("api/odata.svc/orders?$filter=OrderDate eq datetime'2017-03-01T00:00:00' and ShipName eq 'pepe'");
    }
    ...
    public void filterByShipNameAndOrderDateTestCase() throws Exception
    {
        given().header("Accept", "application/json")
                ...
                .header("Content-type", "application/json").statusCode(200)
                .log().ifError()
                .when().get("api/odata.svc/orders?$filter=ShipName eq 'pepe' and OrderDate eq datetime'2017-03-01T00:00:00'");
    }
    ...
    public void testLogicalOperators() throws Exception
    {
        given().header("Accept", "application/json")
                ...
                .header("Content-type", "application/json").statusCode(200)
                .log().ifError()
                .when().get("api/odata.svc/orders?$filter=ShipName eq 'pepe' and (ShipName eq 'pepe' or ShipName eq 'pepe')");
    }
    ...
    public void testLogicalOperators2() throws Exception
    {
        given().header("Accept", "application/json")
                ...
                .header("Content-type", "application/json").statusCode(200)
                .log().ifError()
                .when().get("api/odata.svc/orders?$filter=(ShipName eq 'pepe' or ShipName eq 'pepe') and ShipName eq 'pepe'");
    }
