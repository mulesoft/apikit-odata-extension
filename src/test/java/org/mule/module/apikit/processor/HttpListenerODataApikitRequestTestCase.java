...
public class HttpListenerODataApikitRequestTestCase extends MuleArtifactFunctionalTestCase {
  ...
  @Test
  public void creatingEntityUsingXMLWithInvalidFieldDecimalShouldReturnBadRequest()
      throws Exception {
    given().header("Accept", "application/xml")
        .body("<?xml version=\"1.0\" encoding=\"utf-8\" standalone=\"yes\"?>"
            + "<entry xmlns:d=\"http://schemas.microsoft.com/ado/2007/08/dataservices\" xmlns:m=\"http://schemas.microsoft.com/ado/2007/08/dataservices/metadata\" xmlns=\"http://www.w3.org/2005/Atom\">"
            + "  <title />" + "  <updated>2013-09-18T23:46:19.3857256Z</updated>" + "  <author>"
            + "    <name />" + "  </author>" + "  <id />" + "  <content type=\"application/xml\">"
            + "    <m:properties>" + "      <d:OrderID>18.3</d:OrderID>"
            + "      <d:ShipName>ship-name-1-too-loong</d:ShipName>"
            + "      <d:ShipAddress>ship-address-1</d:ShipAddress>" + "    </m:properties>"
            + "  </content>" + "</entry>")
        .expect().statusCode(400).when().post("api/odata.svc/orders");
  ...
  public void creatingEntityUsingXMLBodyWithDuplicatedFieldsShouldReturn400() throws Exception {
    given().header("Accept", "application/xml").header("Content-Type", "application/xml")
        .body("<?xml version=\"1.0\" encoding=\"utf-8\" standalone=\"yes\"?>"
            ...
            + "  <title />" + "  <updated>2013-09-18T23:46:19.3857256Z</updated>" + "  <author>"
            + "    <name />" + "  </author>" + "  <id />" + "  <content type=\"application/xml\">"
            + "    <m:properties>" + "      <d:OrderID>20000000</d:OrderID>"
  ...
  public void creatingEntityUsingEmptyXMLBodyShouldReturnBadRequest() throws Exception {
    given().header("Accept", "application/xml").body("").expect().statusCode(400).when()
