...
public class ODataApikitRequestEntityWithPkOfTypeStringTestCase
  ...
  public void creatingEntityUsingJSONBodyWithNullProps() throws Exception {
    given().header("Accept", "application/json")
        .body("{\"OrderID\":20000,\"ShipAddress\": null,\"ShipName\":\"ship-name-1\"}").expect()
  ...
  public void creatingEntityUsingJSONBodyWithUndefinedProps() throws Exception {
    given().header("Accept", "application/json")
        .body("{\"OrderID\":20000,\"ShipName\":\"ship-name-1\"}").expect().statusCode(200).when()
