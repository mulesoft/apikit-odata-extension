...
public class ODataApikitRequestEntityWithPkOfTypeStringTestCase extends MuleArtifactFunctionalTestCase
{
    @Rule
    ...
    {
	return "org/mule/module/apikit/odata/processor/apikit-processor-uses-pk-of-type-string.xml";
    }
    ...
    {
    	given().header("Accept", "application/json")
    	.body("{\"OrderID\":20000,\"ShipAddress\": null,\"ShipName\":\"ship-name-1\"}")
        .expect()
        	.statusCode(200)
        .when().post("api/odata.svc/orders");
    }
    ...
    {
    	given().header("Accept", "application/json")
    	.body("{\"OrderID\":20000,\"ShipName\":\"ship-name-1\"}")
        .expect()
        	.statusCode(200)
        .when().post("api/odata.svc/orders");
    }
